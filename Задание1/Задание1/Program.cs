        ...
        static void Main(string[] args)
        {
            ...
            "3. Фаренгейт\n");
                    ...
                    case 9:
                        ...
                        break;
                    case 10:
                        Console.WriteLine("10: вариант 19:");
                        int ch1;
                        Console.WriteLine("Выберете задание:");
                        Console.WriteLine("1.Вывести текущее время");
                        Console.WriteLine("2. Преобразовать секунды в формат \"дни:часы:минуты:секунды\"");
                        ...
                        switch (ch1)
                        {
                            ...
                            case 2:
                                ...
                                int days = hours / 24;
                                hours = hours % 60;
                                Console.WriteLine(seconds + " секунд это: " + days + " дней, " + hours + " часов, " + minutes + " минут, " + secs + " секунд.");
                                break;
                            default:
                                Console.WriteLine("Ошибка ввода");
                                break;
